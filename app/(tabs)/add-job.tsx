...
export default function AddJobScreen() {
  ...
  const selectSuggestion = (suggestion: JobSuggestion) => {
    console.log('AddJobScreen: Selected suggestion:', suggestion);
    ...
    Alert.alert('Auto-filled', `${suggestion.wipNumber} - ${suggestion.vehicleReg} - ${suggestion.aw} AW (${awTimeFormatted})`);
  };
              ...
              <View style={styles.formGroup}>
                ...
                <View style={styles.vhcButtonsRow}>
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      console.log('AddJobScreen: User selected VHC GREEN');
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      console.log('AddJobScreen: User selected VHC ORANGE');
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      console.log('AddJobScreen: User selected VHC RED');
